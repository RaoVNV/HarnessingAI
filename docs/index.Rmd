...
Rao, V.N.V., Jeng, A., Drew, J.M., Kala, B., & Gongati, S. (under review). *Students' statistical thinking when using generative AI: A descriptive case study*. 

Rao, V.N.V., & Ge, X. (in preparation). *Rtutor.AI: Marrying R to ChatGPT to support the development of students' statistical thinking*. 
